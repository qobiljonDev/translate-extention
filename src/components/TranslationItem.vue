    ...
    <div class="flex items-center justify-between mt-2">
      ...
      <div class="flex gap-1">
        ...
        <button
          ...
          class="text-blue-400 hover:text-blue-500 transition-colors p-1.5 rounded-lg hover:bg-blue-500/10"
          title="Tinglash"
        >
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
        ...
        <button
          v-if="removable"
          @click="$emit('remove')"
          class="transition-colors p-1.5 rounded-lg hover:bg-red-500/10 opacity-0 group-hover:opacity-100"
