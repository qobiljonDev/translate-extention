  ...
  <div class="space-y-5">
    ...
    <div class="flex gap-3">
      ...
      <button
        ...
        class="px-4 py-3.5 rounded-xl text-sm font-semibold transition-all duration-200 active:scale-[0.97]"
        :class="pageTranslated
          ? 'bg-gradient-to-r from-orange-600 to-orange-500 text-white hover:from-orange-500 hover:to-orange-400 hover:shadow-lg hover:shadow-orange-500/20'
          : 'bg-gradient-to-r from-emerald-600 to-emerald-500 text-white hover:from-emerald-500 hover:to-emerald-400 hover:shadow-lg hover:shadow-emerald-500/20'"
        :title="pageTranslated ? 'Asl holatga qaytarish' : 'Butun sahifani tarjima qilish'"
      >
        {{ pageTranslated ? "Qaytarish" : "Sahifani tarjima" }}
      </button>
    </div>
